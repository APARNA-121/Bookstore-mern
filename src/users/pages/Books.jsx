  ...
  return (
    ...
    <div className="flex flex-col justify-center items-center my-5">
      ...
      <div className="flex my-5">
        <input type="text" placeholder='Search By Titile' className="border p-2 border-gray-400 w-100" />
          ...
          {/* book card div 1 */}
           <div className="shadow rounded p-3 mx-4">
                ...
                <div className="flex justify-center items-center flex-col mt-4">
                  ...
                  <Link to={'/books/id/view'} className="bg-black py-2 px-5 mt-2 text-white"
                  >View</Link>
                </div>
              </div>
               {/* book card div 2 */}
