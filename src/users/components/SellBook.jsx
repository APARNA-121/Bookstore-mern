        ...
        <div className="p-10 my-20 mx-5 bg-gray-200">
           ...
           <div className="md:grid grid-cols-2 mt-10 w-full">
            <div className="px-3">
                ...
                <div className="mb-3">
                    <textarea type="text" rows={5} placeholder='Abstract' className="p-2 bg-white w-full rounded" />
                </div>
            </div>
            <div className="px-3">
                <div className="mb-3">
                ...
                <div className="mb-3 flex justify-center items-center mt-10">
                    <label htmlFor="uploadImg">
                        ...
                        <img width={'200px'} src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRiNU61bFkEYs08Qatfl-S5PY4Dywiv5L7gqA&s" alt="upload" />
                    </label>
                </div>
            </div>
           </div>
