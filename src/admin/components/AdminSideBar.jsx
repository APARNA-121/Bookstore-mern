  ...
  return (
    <div className='bg-blue-100 md:min-h-screen h-fit md:flex flex-col text-center'>
      ...
      <div className="my-10 flex justify-center items-center">
        <img width={'100px'} height={'100px'} style={{borderRadius:'50%'}} src="https://www.cecyteo.edu.mx/Nova/App_themes/Site2015/assets/admin/pages/media/profile/profile_user.jpg" alt="user" />
      </div>
      {/* name */}
